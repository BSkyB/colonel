...
describe ContentItem do
  ...
  describe "creating" do
    it "should create item with content from hash" do
      c = ContentItem.new('test-type', {foo: 'foo', bar: 'bar'})
    ...
    it "should create item with content from array" do
      c = ContentItem.new('test-type', ['foo', 'bar'])
    ...
    it "should take a document in opts hash and deserialize it's content" do
      ...
      con = ContentItem.new('test-type', nil, document: doc)
  ...
  describe "updating" do
    it "should allow mass updating content" do
      con = ContentItem.new('test-type', {foo: 'foo', bar: 'bar', baz: 'baz'})
  ...
  describe "persisting" do
    ...
    it "should serialize and save content without message" do
      con = ContentItem.new('test-type', {key: 'value', another: ['array']})
    ...
    it "should load and deserialize content" do
      con = ContentItem.new('test-type', nil)
  ...
  describe "search" do
    ...
    describe "indexing" do
      ...
      it "should index a complex the document" do
        ci = ContentItem.new('test-type', title: "Title", tags: ["tag", "another", "one more"], body: "foobar", author: {first: "Viktor", last: "Charypar"})
